		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TAQA Model",
									"targetURL": "#tagamodeluitagamodelui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tagamodeluitagamodelui-display": {
								"semanticObject": "tagamodeluitagamodelui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tagamodelui.tagamodelui",
									"url": sap.ui.require.toUrl("tagamodelui/tagamodelui")
								}
							}
						}
					}
